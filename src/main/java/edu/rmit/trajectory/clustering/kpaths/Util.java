package edu.rmit.trajectory.clustering.kpaths;
...
public class Util {
    ...
    /*
    * convert the difference of lng and lat to distance */

    public static double lngNLatToDistance(double[] a, double[] b) {
...
//            longitude
            double lng1 = Math.toRadians(a[0]);
            double lng2 = Math.toRadians(b[0]);
//            difference
